...
from src.apps.configurator_cli import settings
from src.apps.configurator_cli.commander import build_commander
from src.libs.configurator.shared.infrastructure.container import Builder, Container
